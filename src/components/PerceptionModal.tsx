...
const phaseConfig: Record<string, { label: string; desc: string; colorVar: string; color: string }> = {
  ...
  HOLD: { label: 'HOLD', desc: 'Tarde · Sustentação (12h–17h30)', colorVar: '--vyr-accent-transition', color: '#8F7A4A' },
  CLEAR: { label: 'CLEAR', desc: 'Noite · Recuperação (18h30–23h59)', colorVar: '--vyr-accent-stable', color: '#4F6F64' },
};
